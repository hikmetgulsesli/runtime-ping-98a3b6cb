...
- Runtime Ping turns the user's request into a directly usable web workflow. The first experience must be the actual web product behavior, not a marketing landing page or placeholder demo.
- - FR-001: Build a tiny single-page status tile app called Runtime Ping. It should show three status cards, a timestamp, and one reset button. Keep it simple for pipeline testing. Use static HTML/CSS/JS or the smallest suitable Vite setup. REPO: /Users/setrox/projects/runtime-ping-smoke-20260629-210429. Frontend port:…
...
- Record Operations - Runtime Ping
- Record Editor - Runtime Ping
- Pipeline Board - Runtime Ping
- Insights - Runtime Ping

## SCREEN_SPECS
SCREEN_SPEC_1:
- exact_screen_title: Record Operations - Runtime Ping
...
SCREEN_SPEC_2:
- exact_screen_title: Record Editor - Runtime Ping
...
SCREEN_SPEC_3:
- exact_screen_title: Pipeline Board - Runtime Ping
...
SCREEN_SPEC_4:
- exact_screen_title: Insights - Runtime Ping
